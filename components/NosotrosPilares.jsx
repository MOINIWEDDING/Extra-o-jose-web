...
const DEMO = [
  { id: 'demo-1', title: 'Café de especialidad', body: 'El enfoque está en el specialty coffee: origen del grano dominicano, métodos de extracción y técnica del barista.' },
  { id: 'demo-2', title: 'Atmósfera artística', body: 'Una experiencia bohemia. Diseño industrial con toques acogedores, pensado para creativos, estudiantes y profesionales.' },
];
