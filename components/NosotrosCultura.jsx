...
const DEMO = [
  { id: 'demo-1', tag: 'Sede de eventos', title: 'Escuela de Café de RD', body: 'Colaboramos con la Escuela de Café de República Dominicana, prestando el espacio y la barra para formación y encuentros.' },
  { id: 'demo-2', tag: 'Catas', title: 'Degustaciones de café dominicano', body: 'Anfitriones de catas exclusivas, explorando origen, proceso y perfil de taza.' },
  { id: 'demo-3', tag: 'Experimental', title: 'Caviar de café y aperitivos de autor', body: 'Experiencias gastronómicas alrededor del grano, con degustaciones únicas pensadas para sorprender.' },
];
